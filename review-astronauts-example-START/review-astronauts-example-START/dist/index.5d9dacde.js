...
(0, _astronaut.getAstronauts)().then((allAstronautData)=>{
    ...
    allAstronautData.results.map((astronautData)=>{
        (0, _astronaut1.renderAstronautListItem)(astronautData, astronautListElement);
    });
});
...
parcelHelpers.export(exports, "getAstronauts", ()=>getAstronauts);
...
const renderAstronautListItem = (data, listElement)=>{
    let { name, status, profile_image_thumbnail, date_of_birth, nationality, agency, bio } = data;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4cCs7","1Z4Rq"], "1Z4Rq", "parcelRequire4625")
